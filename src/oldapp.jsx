            ...
            <div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <input value={form.firstName} onChange={handle("firstName")} placeholder="Jane"
                    style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem" }}
                ...
                <div style={{ marginBottom: "1rem" }}>
                  ...
                  <input value={form.lastName} onChange={handle("lastName")} placeholder="Smith"
                    style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem" }}
                    onFocus={e => e.target.style.borderColor = C.cyan} onBlur={e => e.target.style.borderColor = C.border} />
                </div>
              </div>
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input value={form.email} onChange={handle("email")} type="email" placeholder="jane@example.com"
                  style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem" }}
                  onFocus={e => e.target.style.borderColor = C.cyan} onBlur={e => e.target.style.borderColor = C.border} />
              </div>
              <div style={{ marginBottom: "1rem" }}>
                <label style={{ fontSize: "0.66rem", letterSpacing: "0.18em", textTransform: "uppercase", color: C.muted }}>Phone Number</label>
                <input value={form.phone} onChange={handle("phone")} type="tel" placeholder="+44 ..."
                  style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem" }}
                  onFocus={e => e.target.style.borderColor = C.cyan} onBlur={e => e.target.style.borderColor = C.border} />
              </div>
              <div style={{ marginBottom: "1rem" }}>
                ...
                <select value={form.type} onChange={handle("type")}
                  style={{ width: "100%", background: "#0d1117", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem" }}
                  onFocus={e => e.target.style.borderColor = C.cyan} onBlur={e => e.target.style.borderColor = C.border}>
                  <option value="">Please select</option>
                  <option>Individual / Self-employed</option>
                  <option>Contractor or Consultant</option>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <textarea value={form.message} onChange={handle("message")} rows={4}
                  placeholder="Tell us about your accounting, tax, or advisory needs..."
                  style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: `1px solid ${C.border}`, color: C.white, padding: "0.75rem 1rem", fontSize: "0.88rem", outline: "none", marginTop: "0.4rem", resize: "vertical" }}
                  onFocus={e => e.target.style.borderColor = C.cyan} onBlur={e => e.target.style.borderColor = C.border} />
              </div>
