  ...
  return (
    <div style={{ minHeight: "100vh", padding: isMobile ? "6rem 5% 3rem" : "8rem 5% 5rem" }}>
      ...
      <div style={{ textAlign: "center", padding: isMobile ? "2rem 5%" : "3rem 10%", marginBottom: "3rem", borderBottom: `1px solid ${C.border}` }}>
        ...
        <div style={{ fontFamily: "'Bebas Neue'", fontSize: "clamp(1.6rem, 3vw, 2.4rem)", letterSpacing: "0.06em", color: C.pink, lineHeight: 1.35 }}>
      ...
      <div style={{ maxWidth: 1100, margin: "5rem auto 0" }}>
        ...
        <div style={{ paddingTop: "4rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "1.5rem", marginTop: "2rem" }}>
            {[
              { name: "Matthew Sam", credentials: "FCCA, CPA", role: "Managing Partner", quote: "North Lake Advisory provides the financial clarity and strategic insight that businesses need to grow with confidence. Their practical approach to financial leadership and governance makes complex decisions simpler." },
        ...
        {services.map((s, i) => (
          ...
          >
            ...
            <ul style={{ listStyle: "none" }}>
              {s.items.map((item, j) => (
                <li key={j} style={{ fontSize: "0.78rem", color: C.muted, padding: "0.4rem 0", borderBottom: `1px solid ${C.border}`, display: "flex", alignItems: "center", gap: "0.6rem" }}>
                  <span style={{ color: C.cyan, flexShrink: 0 }}>›</span> {item}
                </li>
              ))}
            </ul>
